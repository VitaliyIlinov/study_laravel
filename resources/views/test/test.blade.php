...
@section('content')
    <div class="col-lg-12">
        <a href="/info/single-responsibility" target="_blank" class="list-group-item list-group-item-action">
            Solid.<br>
        ...
        <a href="#advanced2" data-toggle="collapse" class="list-group-item list-group-item-action" aria-expanded="true">
            Для чего нужен интерфейс Iterator?
        </a>
        <div class="multi-collapse collapse show" id="advanced2" style="">
            <div class="card card-body">
        ...
        <div class="collapse multi-collapse" id="advanced5">
            <div class="card card-body">
                <ul>
                    ...
                    <li>$a &gt;&gt; $b <b>Сдвиг вправо</b> Все биты переменной $a сдвигаются на $b позиций вправо (каждая
                        позиция
        ...
        <a href="#advanced6" data-toggle="collapse" class="list-group-item list-group-item-action">
            Как сделать вывод в stderr из PHP-скрипта
        </a>
        <div class="collapse multi-collapse" id="advanced6">
            <div class="card card-body">

            </div>
        </div>
        <a href="#advanced7" data-toggle="collapse" class="list-group-item list-group-item-action">
            Что такое SPL, что прикольного оттуда использовал
        </a>
        <div class="collapse multi-collapse" id="advanced7">
            <div class="card card-body">

            </div>
        </div>
        <a href="#advanced8" data-toggle="collapse" class="list-group-item list-group-item-action">
            Как прочитать файл на 100 ТБ?
        </a>
        <div class="collapse multi-collapse" id="advanced8">
            <div class="card card-body">

            </div>
        </div>
        <a href="#advanced9" data-toggle="collapse" class="list-group-item list-group-item-action">
            Нужно ли после генератора писать return?
        </a>
        <div class="collapse multi-collapse" id="advanced9">
            <div class="card card-body">
        ...
        <div class="collapse multi-collapse" id="index5">
            <div class="card card-body">
                <ul>
                    <li><b>btree</b>(хранит элементы в отсортированном порядке) -поиск по диапазонам, =, &gt;, &gt;=, &lt;, &lt;=,
                        or
                        BETWEEN operators
                        <ul>
                            <li>primary</li>
                    ...
                    <li><b>hash</b> MEMORY table "=" очень быстро, не может использоваться для операций диапазонов &gt; и &lt;
                    </li>
                </ul>
            </div>
        </div>
